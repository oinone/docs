...
prev:
  text: 动作
  link: /handbook/UserHandbook/Designers/UIDesigner/Component Introduction/action.md
next:
  text: 自定义组件管理
  link: /handbook/UserHandbook/Designers/UIDesigner/Custom Components/Custom Component Management.md
---
# 组件化设计
